...
export const Hero = (props: ProductTeaserCardProps) => {
  const { user } = useUser()
  const {
    dailyVolumeLabel = "TECHNIQUES MASTERED DAILY",
    headline = "Master Martial Arts Through Structured Learning",
    subheadline = "Break down complex techniques into clear, actionable lessons. Master grappling, striking, and complete MMA through step-by-step systems designed to remove guesswork and accelerate real skill development.",
    // videoSrc = "",
    ...
    <section className="w-full px-8 pt-20 pb-16">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-12 gap-2">
          ...
          >
            <Card className="border-none shadow-none rounded-[40px] h-full bg-transparent px-0!">
              <CardContent className="md:px-0! p-12 sm:p-8 lg:p-16 flex flex-col justify-start lg:justify-end lg:aspect-square overflow-hidden">
                <a
                  ...
                  {user ? (
                    ...
                    <>
                      <SignUpButton mode="modal" forceRedirectUrl="/account-setup">
                        <Button className="px-[18px] py-[15px] h-auto text-base leading-4 transition-all duration-150">
                          {primaryButtonText}
                        </Button>
                      </SignUpButton>
                      <Button
          ...
          >
            <Card
              ...
              style={{
                backgroundImage:
                  "url(https://images.unsplash.com/photo-1549060279-7e168fcee0c2?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.1.0)",
